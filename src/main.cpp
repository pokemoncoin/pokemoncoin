...
uint256 hashGenesisBlock("0x314e6327f67e57753e72057c7a4ba2a2671e76f8da937603cd5bad8bb51793ee");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // pokemoncoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "pokemoncoin Signed Message:\n";
...
{
    // pokemoncoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 500000000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 70000); // pokemoncoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2592000; // pokemoncoin: 3.5 days
static const int64 nTargetSpacing = 15; // pokemoncoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // pokemoncoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // pokemoncoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // pokemoncoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xac00ce9700e973ff379e4ee1e644f75c6f6d98e4db5447ce43e8bec67d0ff584");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Pokemon Coin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500000000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("0e6dc94c641581c2e016fe4eaec53e5565f72bf1ce6d527f1a6dbc4b7a516d8bcd59714e0163865ef8239c0d4397e0f592fa2fc2b672e0a33fbcbf08c249b83441") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1458580824;
        block.nBits    = 504365644;
        block.nNonce   = 3685872454;

        if (fTestNet)
        {
            block.nTime    = 1458580824;
            block.nNonce   = 1203278019;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x4b090bdddb2bc53cb8db8efcc8e1621677b1570178ac2ac11b1b1815c7d11da8"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // pokemoncoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("pokemoncoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("pokemoncoinMiner : ProcessBlock, block not accepted");
    }
